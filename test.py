...
# for i in deckdata:
#     if (i["Id"] == 302060501001):
#         print(i["MDeckDetails"][0]['Status']['Defence'])
#         print(i["MDeckDetails"][0]['Status']['MindDefence'])
...
#     min = int(time.strftime('%z')[3:])
# # 怕活动打不完 多准备一个小时
# jp_time = now_time - datetime.timedelta(hours=(int(time.strftime('%z')[0:3])-202), minutes=(min))
# print(jp_time)

# begin_stage = 31500101
